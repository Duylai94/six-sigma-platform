...
export function Flashcard({
    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face (Question) */}
                <Card className="absolute h-full w-full [backface-visibility:hidden] flex flex-col border-primary/20 hover:shadow-lg hover:border-primary/40 transition-all p-0 overflow-hidden">
                ...
                {/* Back Face (Answer) */}
                <Card className="absolute h-full w-full [backface-visibility:hidden] [transform:rotateY(180deg)] flex flex-col border-primary/20 bg-primary/5 p-0 overflow-hidden">
